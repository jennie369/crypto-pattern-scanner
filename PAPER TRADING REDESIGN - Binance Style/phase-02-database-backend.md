...
## Deliverables
- [x] Database migration script created và executed
- [x] `paper_trading_orders` table có đủ columns mới (9 columns + indexes)
- [x] executeBuy/executeSell updated để handle order types (Market/Limit/Stop-Limit)
- [x] TP/SL order creation logic implemented (createTPOrder + createSLOrder)
- [x] Order execution engine updated (OrderMonitor service)
- [x] cancelOrder function implemented
