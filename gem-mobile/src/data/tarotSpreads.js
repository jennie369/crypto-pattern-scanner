...
export const DEFAULT_SPREADS = [
  ...
  },
  {
    ...
    description_vi: 'Khám phá sự cân bằng giữa tâm trí, thể xác và tâm linh.',
    cards: 3,
    category: 'general',
    tier_required: 'FREE',
    positions: [
      ...
      { index: 2, name_vi: 'Tâm linh', name_en: 'Spirit', description_vi: 'Kết nối tâm linh và trực giác' },
    ],
    layout_type: 'horizontal',
    estimated_time: '5-7 phút',
    display_order: 3,
