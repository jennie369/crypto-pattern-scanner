    ...
    items: [
      {
        ...
        html: `<div class="image-placeholder" style="margin-top: 16px; margin-left: auto; margin-right: auto; margin-bottom: 40px; padding: 1.5rem 1rem; width: 100%; max-width: 800px; background: rgba(255,255,255,0.02); border: 2px dashed rgba(255,255,255,0.15); border-radius: 12px; text-align: center; min-height: 80px; box-sizing: border-box; display: block;">
