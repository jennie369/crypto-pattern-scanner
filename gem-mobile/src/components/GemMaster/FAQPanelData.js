...
export const FAQ_QUESTIONS = {
  ...
  suggest: [
    // === FREE templates ===
    {
      id: 'suggest_gratitude',
      text: 'Viết nhật ký biết ơn hôm nay',
      action: 'template',
      templateId: 'gratitude',
      requiredTier: null,
    },
    {
      id: 'suggest_free_form',
      text: 'Viết nhật ký tự do — giải tỏa tâm trí',
      action: 'template',
      templateId: 'free_form',
      requiredTier: null,
    },
    {
      id: 'suggest_goal',
      text: 'Đặt mục tiêu mới cho tháng này',
      action: 'inline_form',
      formType: 'goal_setting',
      requiredTier: null,
    },
    {
      id: 'suggest_manifest_wealth',
      text: 'Manifest tiền bạc & thịnh vượng',
      action: 'inline_form',
    ...
    {
      id: 'suggest_fear_setting',
      text: 'Đối diện nỗi sợ (Fear-Setting)',
      action: 'template',
      templateId: 'fear_setting',
      requiredTier: 'tier1',
      tierLabel: 'Pro',
    },
    {
      id: 'suggest_think_day',
      text: 'Think Day — review cuộc sống',
      action: 'template',
      templateId: 'think_day',
      requiredTier: 'tier1',
      tierLabel: 'Pro',
    },
    {
      id: 'suggest_weekly',
      text: 'Lên kế hoạch tuần mới',
      action: 'template',
      templateId: 'weekly_planning',
      requiredTier: 'tier1',
      tierLabel: 'Pro',
    },
    // === TIER 2 (Premium) templates ===
    {
      id: 'suggest_trading_journal',
      text: 'Nhật ký giao dịch Trading',
      action: 'template',
      templateId: 'trading_journal',
      requiredTier: 'tier2',
      tierLabel: 'Premium',
    },
    {
      id: 'suggest_vision',
      text: 'Tầm nhìn 3-5 năm',
      action: 'template',
      templateId: 'vision_3_5_years',
      requiredTier: 'tier2',
      tierLabel: 'Premium',
    },
    {
      id: 'suggest_daily_wins',
      text: 'Ghi nhận chiến thắng hôm nay',
      action: 'template',
      templateId: 'daily_wins',
      requiredTier: 'tier2',
      tierLabel: 'Premium',
    },
    // === TIER 3 (VIP) templates ===
    {
      id: 'suggest_prosperity',
      text: 'Tần Số Thịnh Vượng — manifest tài chính',
      action: 'template',
      templateId: 'prosperity_frequency',
      requiredTier: 'tier3',
      tierLabel: 'VIP',
    },
    {
      id: 'suggest_trading_psychology',
      text: 'Tâm lý giao dịch nâng cao',
      action: 'template',
      templateId: 'advanced_trading_psychology',
      requiredTier: 'tier3',
      tierLabel: 'VIP',
    },
  ],
  ...
  courses: [
    ...
    },
    {
      ...
      courseTags: ['Tần Số Gốc', 'Khai Mở', '7 Ngày', 'Khóa học'],
    },
    {
      id: 'courses_love',
      ...
      courseTags: ['Tình Yêu', 'Tần Số', 'Khóa học'],
    },
    {
      ...
      courseTags: ['Tư Duy Triệu Phú', 'Manifest', 'Khóa học'],
    },
    {
      id: 'courses_tier2',
