-- ============================================================
-- PAYMENT SYSTEM - SAFE UPDATE (v3)
-- Chỉ update policies và functions, bỏ qua tables/constraints đã tồn tại
-- ============================================================

-- ============================================================
-- 1. FIX RLS POLICIES (Drop and recreate)
-- ============================================================
...
-- ============================================================
-- 2. FUNCTIONS (CREATE OR REPLACE - always safe)
-- ============================================================
...
-- DONE!
-- ============================================================
SELECT 'Payment system migration v3 completed!' as status;
