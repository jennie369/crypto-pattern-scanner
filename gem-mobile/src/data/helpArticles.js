  ...
  'affiliate-marketing-huong-dan-chi-tiet': {
    ...
    content: {
      blocks: [
        ...
        {
          type: 'table',
          headers: ['CTV Tier', 'Digital', 'Physical', 'Sub-Affiliate', 'Ngưỡng doanh số'],
          rows: [
            ['🥉 Bronze', '10%', '6%', '2%', '0 VND'],
            ['🥈 Silver', '15%', '8%', '2.5%', '50M VND'],
            ['🥇 Gold', '20%', '10%', '3%', '150M VND'],
            ['💎 Platinum', '25%', '12%', '3.5%', '400M VND'],
            ['👑 Diamond', '30%', '15%', '4%', '800M VND'],
            ['⭐ KOL', '20%', '20%', '3.5%', '20K+ followers'],
          ],
        },
        {
          type: 'callout',
          ...
          items: [
            {
              ...
              description: 'Vào: Tab "Tài Sản" → Kéo xuống mục "Chương Trình Partnership"',
            },
            {
              number: 2,
              title: 'Chọn chương trình',
              description: 'Chọn 1 trong 2:\n• CTV 5 Cấp: Ai cũng được tham gia, hoa hồng 10-30%\n• KOL Affiliate: Dành cho Influencer (20K+ followers), hoa hồng 20%',
            },
            {
              number: 3,
              title: 'Điền thông tin đăng ký',
              description: 'Form yêu cầu:\n• Họ tên đầy đủ\n• Số CMND/CCCD\n• Email & Số điện thoại\n• Thông tin thanh toán (Ngân hàng/Momo)\n• KOL: Link social media (20K+ followers)',
              tips: ['Thông tin phải chính xác để nhận được tiền'],
            },
            {
              number: 4,
              title: 'Chờ phê duyệt',
              description: 'CTV: Tự động duyệt sau 3 ngày\nKOL: Admin review trong 1-2 ngày làm việc',
            },
            {
              number: 5,
              title: 'Nhận mã giới thiệu & bắt đầu',
              description: 'Sau khi duyệt, bạn nhận mã giới thiệu riêng. Chia sẻ link để kiếm hoa hồng!',
            },
          ],
        },
        {
