# Placeholder Images - TIER 1 Chapter 2: Vùng Tần Số Cơ Bản

## Bài 2.1: HFZ (High Frequency Zone) Là Gì?
...
## Bài 2.2: LFZ (Low Frequency Zone) Là Gì?
...
## Bài 2.3: Cách Nhận Diện Zone Trên Biểu Đồ

### Hình 1: consolidation-zone.png
- **Vị trí trong bài:** Section 1 - Nguyên Tắc Cơ Bản
- **Mô tả:** Biểu đồ zoom vào vùng tích lũy với 4-5 nến thân nhỏ, range hẹp. Đánh dấu đặc điểm: "Thân nhỏ", "Range < 1.5%", "2-5 nến".
- **Kích thước đề xuất:** 800x400
...
## Bài 2.4: Nguyên Tắc Giao Dịch Với Zone

### Hình 1: retest-principle.png
- **Vị trí trong bài:** Section 1 - Đợi Giá Quay Lại
- **Mô tả:** So sánh 2 scenarios: (1) Chase breakout ngay → thua, (2) Đợi retest → thắng. Dùng biểu đồ split view.
- **Kích thước đề xuất:** 900x500

### Hình 2: confirmation-candles.png
- **Vị trí trong bài:** Section 2 - Nến Xác Nhận
- **Mô tả:** Grid 6 nến xác nhận: Shooting Star, Bearish Engulfing, Evening Star (cho HFZ) và Hammer, Bullish Engulfing, Morning Star (cho LFZ).
- **Kích thước đề xuất:** 800x600
...
## Bài 2.5: Giới Hạn TIER 1 và Preview TIER 2

### Hình 1: tier-comparison.png
- **Vị trí trong bài:** Section 2 - Giới Hạn
- **Mô tả:** Bảng so sánh TIER 1 vs TIER 2: độ chính xác, công cụ, patterns được dạy.
- **Kích thước đề xuất:** 800x400

### Hình 2: 4-patterns-preview.png
- **Vị trí trong bài:** Section 3 - Preview TIER 2
- **Mô tả:** Grid 4 patterns: DPD, UPU, UPD, DPU với biểu đồ mini cho mỗi pattern và Win Rate.
- **Kích thước đề xuất:** 900x600

### Hình 3: learning-path.png
- **Vị trí trong bài:** Section 4 - Bước Tiếp Theo
- **Mô tả:** Roadmap từ TIER 1 → TIER 2 → TIER 3 với icons và mô tả ngắn cho mỗi tier.
- **Kích thước đề xuất:** 800x300
