...
export const SCENARIOS = {
  ...
  money_spiritual_conflict: {
    ...
    type: 'money',
    frequency: { min: 50, max: 75 },
    frequencyName: 'Xung đột tâm linh-vật chất',
    triggers: ['guilt', 'shame', 'pride'],
    minScore: 6,
    title: 'Nghiệp Tiền: Xung Đột Tu Hành vs Giàu Có',
    description: 'Bạn tin rằng người tu hành hoặc tâm linh không nên giàu.',
  ...
  frequency_spiritual_bypass: {
    ...
    type: 'frequency',
    frequency: { min: 175, max: 200 },
    frequencyName: 'Né tránh qua tâm linh',
    triggers: ['pride', 'apathy'],
    minScore: 4,
    title: 'Cảnh Báo: Né Tránh Qua Tâm Linh',
    description: 'Bạn dùng tâm linh để tránh đối mặt với vấn đề thực tế.',
    rootCause: 'Nghĩ rằng "nghĩ tích cực" là đủ mà không hành động.',
    healing: [
      'Tâm linh = công cụ, không phải nơi trốn tránh',
      'Đối mặt với vấn đề thực tế + áp dụng công cụ tâm linh',
      'Khẳng định: "Tôi cân bằng giữa tâm linh và thực tế"',
    ],
    crystal: 'Hematite',
    course: 'course_frequency',
  },
