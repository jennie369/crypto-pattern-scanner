...
const INTENT_PATTERNS = {
  ...
  // VIP Templates (Tier 3)
  prosperity_frequency: {
    keywords: [
      // Vietnamese - wealth/prosperity keywords
      /tần số thịnh vượng/i,
      /tan so thinh vuong/i,
      /thịnh vượng/i,
      /thinh vuong/i,
      /dồi dào/i,
      /doi dao/i,
      ...
      /năng lượng tiền/i,
      /nang luong tien/i,
      /mối quan hệ với tiền/i,
      /moi quan he voi tien/i,
      /chữa lành tiền bạc/i,
      /chua lanh tien bac/i,
      // English
      /prosperity/i,
      /abundance/i,
      /wealth frequency/i,
  ...
  advanced_trading_psychology: {
    keywords: [
      // Vietnamese - trading psychology keywords
      /tâm lý giao dịch/i,
      /tam ly giao dich/i,
      /tâm lý trading/i,
      /tam ly trading/i,
      ...
      /sợ vào lệnh/i,
      /so vao lenh/i,
      /căng thẳng trading/i,
      /cang thang trading/i,
      /kiểm soát cảm xúc/i,
      /kiem soat cam xuc/i,
      /bias trong trading/i,
      /cognitive bias/i,
      /kỷ luật giao dịch/i,
      /ky luat giao dich/i,
      /vi phạm quy tắc/i,
