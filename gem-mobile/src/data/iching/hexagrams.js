...
export const HEXAGRAMS = {
  1: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Về mặt tâm linh, Càn tượng trưng cho sự giác ngộ. Kết nối mạnh với năng lượng vũ trụ. Thời điểm tốt để đặt intentions, manifesting. Ý chí mạnh mẽ giúp vượt qua thử thách. Đây là lúc để nhìn nhận bản thân như một người sáng tạo cuộc sống, không phải nạn nhân của hoàn cảnh.`,
        actionSteps: [
  ...
  2: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Về tâm linh, Khôn dạy về sự tiếp nhận và buông bỏ ego. Hãy mở lòng đón nhận hướng dẫn từ vũ trụ thay vì cố kiểm soát mọi thứ. Thực hành thiền định, kết nối với năng lượng Đất Mẹ. Học cách tin tưởng vào quá trình.`,
        actionSteps: [
  ...
  3: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Đây là thời điểm thử thách tâm linh. Những khó khăn giúp bạn trưởng thành. Hãy xem đây là bài học từ vũ trụ. Tìm kiếm ý nghĩa trong thử thách. Đức tin sẽ giúp bạn vượt qua.`,
        actionSteps: [
          'Xem khó khăn như cơ hội học hỏi và trưởng thành',
          'Thực hành lòng biết ơn dù trong hoàn cảnh khó khăn',
          'Kết nối với cộng đồng tâm linh để được hỗ trợ',
        ],
      },
    },
  ...
  4: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Con đường tâm linh cần có thầy dẫn dắt. Đừng tự mình mò mẫm. Tìm người hướng dẫn đáng tin cậy, tham gia cộng đồng tâm linh. Học hỏi với tâm mở và khiêm tốn.`,
        actionSteps: [
          'Tìm thầy hoặc cộng đồng tâm linh phù hợp',
  ...
  5: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Đây là thời kỳ chuẩn bị tâm linh. Tích lũy năng lượng, thiền định, và nuôi dưỡng tâm hồn. Sự giác ngộ sẽ đến khi bạn sẵn sàng. Tin tưởng vào divine timing.`,
        actionSteps: [
          'Thiền định đều đặn mỗi ngày',
          'Đọc sách tâm linh để nuôi dưỡng tâm hồn',
    ...
    crystals: [
      ...
      },
      {
        ...
        reason: 'Kết nối tâm linh và sự an bình',
  ...
  6: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Xung đột bên ngoài phản ánh mâu thuẫn bên trong. Hãy nhìn vào bản thân để hiểu nguyên nhân. Học cách buông bỏ ego và tha thứ. Xung đột là cơ hội để trưởng thành tâm linh.`,
        actionSteps: [
  ...
  7: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Con đường tâm linh cần kỷ luật và thực hành đều đặn. Thiền định, tụng kinh hoặc yoga cần được thực hành hàng ngày. Tìm cộng đồng tu tập để hỗ trợ lẫn nhau.`,
        actionSteps: [
          'Thiền định mỗi ngày cùng một giờ',
          'Tham gia group tu tập hoặc sangha',
          'Giữ kỷ luật trong thực hành tâm linh',
        ],
      },
    },
  ...
  8: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Con đường tâm linh cần sangha (cộng đồng). Tham gia nhóm thiền, lớp yoga hoặc cộng đồng tâm linh. Năng lượng tập thể mạnh hơn cá nhân.`,
        actionSteps: [
    ...
    interpretations: {
      ...
      spiritual: {
        ...
        actionSteps: [
          ...
          'Đọc 1 trang sách tâm linh mỗi ngày',
  ...
  10: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Con đường tâm linh cần sự kính trọng và khiêm tốn. Tôn kính thầy, tôn trọng truyền thống. Không kiêu ngạo dù có tiến bộ. Đi từng bước chắc chắn.`,
        actionSteps: [
          'Giữ sự kính trọng với thầy và truyền thống',
          'Không khoe khoang sự tiến bộ tâm linh',
  ...
  11: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Tâm linh an lạc, cảm giác kết nối với vũ trụ. Đây là thời điểm tốt để thiền định, tu tập. Chia sẻ năng lượng tích cực với người khác. Lòng biết ơn nhân đôi phước lành.`,
        actionSteps: [
  ...
  12: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Giai đoạn này là thử thách tâm linh. Giữ vững niềm tin dù hoàn cảnh khó khăn. Đây là cơ hội để nhìn lại bản thân, thanh lọc và chuẩn bị cho giai đoạn mới.`,
        actionSteps: [
  ...
  13: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Tu tập trong cộng đồng sangha. Tìm nhóm thiền hoặc yoga cùng chí hướng. Năng lượng tập thể mạnh mẽ hơn cá nhân. Chia sẻ hành trình tâm linh với người khác.`,
        actionSteps: [
          'Tham gia sangha hoặc nhóm tu tập',
          'Chia sẻ kinh nghiệm tâm linh',
  ...
  14: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Tâm linh phong phú, kết nối mạnh với nguồn năng lượng cao hơn. Đây là lúc để chia sẻ ánh sáng với người khác. Giảng dạy, viết sách hoặc mentor về tâm linh.`,
        actionSteps: [
          'Chia sẻ hiểu biết tâm linh',
          'Mentor hoặc hướng dẫn người khác',
          'Đóng góp cho cộng đồng tâm linh',
        ],
      },
    },
  ...
  15: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Khiêm tốn là đức hạnh tâm linh cao nhất. Buông bỏ ego, không khoe khoang về sự tiến bộ tâm linh. Tu trong đời thường, không cần phô trương.`,
        actionSteps: [
          'Tu tập trong im lặng',
          'Không khoe khoang về tâm linh',
  ...
  16: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Tâm linh cũng cần niềm vui. Đừng quá nghiêm túc trong tu tập. Tham gia các buổi lễ, ceremonies với lòng hoan hỷ. Ăn mừng hành trình tâm linh.`,
        actionSteps: [
          'Tham gia ceremonies hoặc lễ hội tâm linh',
          'Tìm niềm vui trong thực hành',
          'Chia sẻ niềm vui tâm linh',
        ],
      },
    },
  ...
  19: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Sự giác ngộ đang đến gần. Tâm linh phát triển. Có thể được giao vai trò hướng dẫn người khác. Sử dụng ảnh hưởng tâm linh một cách có trách nhiệm.`,
        actionSteps: [
  ...
  22: {
    ...
    interpretations: {
      ...
      spiritual: {
        title: 'Tâm Linh & Phát Triển Bản Thân',
        reading: `Vẻ đẹp tâm linh đến từ bên trong. Đừng chạy theo hình thức tu tập. Trang trí bàn thờ đẹp là tốt, nhưng lòng thành mới quan trọng.`,
        actionSteps: [
  ...
  23: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Giai đoạn thanh lọc và buông bỏ. Để cho những gì cũ rơi đi.', actionSteps: ['Buông bỏ những gì không còn phục vụ', 'Thiền định và tĩnh tâm', 'Tin vào chu kỳ mới'] },
    },
    crystals: [
  ...
  24: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Tâm linh được tái sinh. Hy vọng và niềm tin quay trở lại.', actionSteps: ['Đón nhận năng lượng mới', 'Bắt đầu thực hành lại', 'Tri ân hành trình đã qua'] },
    },
    crystals: [
  ...
  25: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Tu tập tự nhiên, không gượng ép. Đạo ở trong đời thường.', actionSteps: ['Tu trong đời sống', 'Không chạy theo hình thức', 'Sống chân thật'] },
    },
    crystals: [
  ...
  26: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Tích lũy đức hạnh và trí tuệ. Tu tập đều đặn.', actionSteps: ['Tu tập hàng ngày', 'Tích đức', 'Nuôi dưỡng tâm linh'] },
    },
    crystals: [
  ...
  27: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Nuôi dưỡng tâm hồn bằng sách, thiền, và tư tưởng tốt.', actionSteps: ['Đọc sách tâm linh', 'Thiền định', 'Tránh thông tin tiêu cực'] },
    },
    crystals: [
  ...
  28: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Thử thách tâm linh lớn. Cần can đảm và đức tin.', actionSteps: ['Giữ vững niềm tin', 'Đối mặt với thử thách', 'Vượt qua giới hạn bản thân'] },
    },
    crystals: [
  ...
  29: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Đây là thử thách tâm linh sâu sắc. Đức tin được thử nghiệm.', actionSteps: ['Giữ vững niềm tin', 'Thiền định trong khó khăn', 'Học bài học từ thử thách'] },
    },
    crystals: [
  ...
  30: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Ánh sáng tâm linh đang tỏa sáng. Soi sáng cho bản thân và người khác.', actionSteps: ['Chia sẻ ánh sáng', 'Gắn kết với nguồn tâm linh', 'Thiền định với lửa'] },
    },
    crystals: [
  ...
  31: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Cảm ứng với năng lượng vũ trụ. Kết nối tâm linh sâu sắc.', actionSteps: ['Thiền định để cảm ứng', 'Kết nối với vũ trụ', 'Mở chakra tim'] },
    },
    crystals: [
  ...
  32: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Kiên trì tu tập. Đạo không có shortcut.', actionSteps: ['Tu tập hàng ngày', 'Kiên trì không gián đoạn', 'Bền bỉ trên con đường'] },
    },
    crystals: [
  ...
  33: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Ẩn tu. Rút lui khỏi thế tục để tu tập.', actionSteps: ['Ẩn cư tu tập', 'Rút lui khỏi ồn ào', 'Thiền định trong im lặng'] },
    },
    crystals: [
  ...
  34: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Sức mạnh tâm linh. Dùng để giúp đỡ, không để phô trương.', actionSteps: ['Dùng sức mạnh để phục vụ', 'Không kiêu ngạo', 'Tu tập với năng lượng'] },
    },
    crystals: [
  ...
  35: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Tiến bộ trên con đường tâm linh. Giác ngộ dần dần.', actionSteps: ['Tiếp tục tu tập', 'Nâng cao hiểu biết', 'Chia sẻ ánh sáng'] },
    },
    crystals: [
  ...
  36: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Thời kỳ thử thách tâm linh. Giữ ánh sáng bên trong.', actionSteps: ['Tu tập trong im lặng', 'Giữ đức tin', 'Chờ đợi ánh sáng trở lại'] },
    },
    crystals: [
  ...
  37: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Tu tập trong gia đình. Gia đình là đạo tràng.', actionSteps: ['Tu tập cùng gia đình', 'Giữ hòa khí trong nhà', 'Làm gương cho con cháu'] },
    },
    crystals: [
  ...
  38: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Đối mặt với mâu thuẫn nội tâm. Hòa giải bên trong.', actionSteps: ['Hòa giải nội tâm', 'Chấp nhận các mặt đối lập', 'Tìm sự cân bằng'] },
    },
    crystals: [
  ...
  39: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Con đường tâm linh gặp trở ngại. Cần thầy hướng dẫn.', actionSteps: ['Tìm thầy chỉ dẫn', 'Không tự mình mò mẫm', 'Kiên trì tu tập'] },
    },
    crystals: [
  ...
  40: {
    ...
    interpretations: {
      ...
      spiritual: { title: 'Tâm Linh', reading: 'Giải thoát tâm linh. Buông bỏ gánh nặng.', actionSteps: ['Buông bỏ quá khứ', 'Tha thứ cho mình và người', 'Nhẹ nhàng bước tiếp'] },
    },
    crystals: [
