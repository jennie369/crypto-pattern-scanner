  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('Shop', { screen: 'CourseList' })}
        activeOpacity={0.8}
      >
      ...
      <View style={styles.quickActions}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('Shop', { screen: 'CourseList', params: { filter: 'enrolled' } })}
        >
        ...
        <TouchableOpacity
          style={[styles.quickBtn, styles.quickBtnWide]}
          onPress={() => navigation.navigate('Shop', { screen: 'CourseList', params: { filter: 'completed' } })}
        >
