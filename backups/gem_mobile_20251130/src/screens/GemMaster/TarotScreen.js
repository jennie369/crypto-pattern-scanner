...
import { ArrowLeft, RefreshCw, Share2, Layers, Star, Moon, Sun, Lock, Briefcase, DollarSign, Heart, Activity, Sparkles, ChevronDown, ChevronUp, ShoppingBag, RotateCcw } from 'lucide-react-native';
      ...
      >
        ...
        <SmartFormCard
          ...
          onSave={(widgetData) => {
            ...
            Alert.alert('Đã lưu!', 'Trải bài đã được thêm vào Dashboard của bạn.');
          }}
          onCancel={() => {
            setShowWidgetForm(false);
          }}
