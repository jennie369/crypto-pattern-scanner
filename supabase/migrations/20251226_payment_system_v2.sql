-- ============================================================
-- PAYMENT AUTOMATION SYSTEM (v2 - Idempotent)
-- Created: 2024-12-26
...
-- Add constraints if not exist (ignore errors)
DO $$ BEGIN
  ALTER TABLE pending_payments ADD CONSTRAINT unique_pending_shopify_order UNIQUE(shopify_order_id);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE pending_payments ADD CONSTRAINT unique_pending_order_number UNIQUE(order_number);
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
...
-- Function: Check expired payments
...
-- Success message
DO $$ BEGIN RAISE NOTICE 'Payment system migration completed successfully!'; END $$;
